      ...
      <div class="col-lg-2 col-sm-12 wow fadeInUp" data-wow-delay="0.1s">
        <div class="service-item text-center pt-3">
          <div class="p-4">
            ...
            <h5 class="mb-3 notranslate">Synergy</h5>
          </div>
        </div>
      </div>
      <div class="col-lg-2 col-sm-12 wow fadeInUp" data-wow-delay="0.3s">
        <div class="service-item text-center pt-3">
          <div class="p-4">
            ...
            <h5 class="mb-3 notranslate">Morality</h5>
          </div>
        </div>
      </div>
      <div class="col-lg-2 col-sm-12 wow fadeInUp" data-wow-delay="0.5s">
        <div class="service-item text-center pt-3">
          <div class="p-4">
            ...
            <h5 class="mb-3 notranslate">Adaptif</h5>
          </div>
        </div>
      </div>
      <div class="col-lg-2 col-sm-12 wow fadeInUp" data-wow-delay="0.5s">
        <div class="service-item text-center pt-3">
          <div class="p-4">
            ...
            <h5 class="mb-3 notranslate">Responsif</h5>
          </div>
        </div>
      </div>
      <div class="col-lg-2 col-sm-12 wow fadeInUp" data-wow-delay="0.7s">
        <div class="service-item text-center pt-3">
          <div class="p-4">
            ...
            <h5 class="mb-3 notranslate">Trust</h5>
            <p></p>
          </div>
        </div>
      </div>
