    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <div class="navbar-nav mx-auto p-4 p-lg-0">
          ...
          {{ request()->is('profil*') ? 'active txt-utama' : '' }}"
            ...
            <div class="nav-item dropdown ">
                <a href="#"
                    class="nav-link dropdown-toggle {{ request()->is('akademik*') ? 'active txt-utama' : '' }}"
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li class="nav-item dropdown drop-down02">
                                ...
                                <ul class="dropdown-menu sub-menu02" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item {{ request()->is('layanan/fasilitas/kriminologi') ? 'active bg-utama' : '' }}"
                                            href="{{ url('layanan/fasilitas/kriminologi') }}">Lab.
                                            Pidana & Kriminologi</a></li>
                                    <li><a class="dropdown-item {{ request()->is('layanan/fasilitas/konstitusi') ? 'active bg-utama' : '' }}"
                                            href="{{ url('layanan/fasilitas/konstitusi') }}">Lab.
                                            Konstitusi
                                            (vicon)</a></li>
                                    <li><a class="dropdown-item {{ request()->is('layanan/fasilitas/ruang-baca') ? 'active bg-utama' : '' }}"
            ...
            <div class="nav-item dropdown ">
                <a href="#"
                    class="nav-link dropdown-toggle {{ request()->is('berita') ? 'active txt-utama' : '' }}"
