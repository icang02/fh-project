...
@section('main-content')
    ...
    <div class="container-xxl py-5 pt-custom">
        <div class="container px-0 px-md-5">
            <div class="row">
                <div class="col">
                    <h5 class="text-center">PUBLIKASI</h5>
                    <hr class="w-25 mx-auto my-5" style="height: 3px">
                    <img src="https://www.uho.ac.id/fakultas/fhukum/wp-content/uploads/sites/7/2019/04/FE4-2.jpg"
                        class="img-fluid">

                    <div class="isi mt-5">
                        <p>Daftar Pengabdian Kepada Masyarakat Tahun 2015</p>
                        <table class="table table-borderless">
                            <thead>
                                <tr>
                                    <th scope="col">No</th>
                                    <th scope="col">Judul</th>
                                    <th scope="col">Nama Nama Dosen</th>
                                    <th scope="col">Dihasilkan / Dipublikasikan pada</th>
                                    <th scope="col">tahun penyajian/publikasi</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
