            ...
            <div class="card-body">
              ...
              <div class="example">
                <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/components/tooltips/#examples" target="_blank">
                      <svg class="icon me-2">
              ...
              <div class="example">
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item"><a class="nav-link active" data-coreui-toggle="tab" href="#preview-1284" role="tab">
                      <svg class="icon me-2">
                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-media-play"></use>
                      </svg>Preview</a></li>
                  <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/components/tooltips/#examples" target="_blank">
                ...
                <div class="tab-content rounded-bottom">
                  <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1284">
            ...
            <div class="card-body">
              ...
              <div class="example">
                <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/components/tooltips/#disabled-elements" target="_blank">
                      <svg class="icon me-2">
                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
                      </svg>Code</a></li>
                </ul>
                <div class="tab-content rounded-bottom">
                  <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-428"><span class="d-inline-block" tabindex="0" data-coreui-toggle="tooltip" data-coreui-original-title="Disabled tooltip">
