    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            ...
            <ul class="nav-group-items">
                ...
                <li class="nav-item"><a class="nav-link"
                        href="{{ url('/dashboard/profil/rencana-operasional') }}"><span class="nav-icon"></span>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            ...
            <ul class="nav-group-items">
                <li class="nav-item"><a class="nav-link"
                        href="{{ url('/dashboard/program-studi/sejarah-prodi') }}"><span class="nav-icon"></span>
                        Sejarah</a></li>
                <li class="nav-item"><a class="nav-link"
                        href="{{ url('/dashboard/program-studi/visi-misi-prodi') }}"><span class="nav-icon"></span>
                        Visi Misi</a></li>
                <li class="nav-item"><a class="nav-link"
                        href="{{ url('/dashboard/program-studi/tujuan-prodi') }}"><span class="nav-icon"></span>
                        Tujuan</a></li>
                <li class="nav-item"><a class="nav-link"
                        href="{{ url('/dashboard/program-studi/sasaran-strategis-prodi') }}"><span
                            class="nav-icon"></span> Sasaran
                        Strategis</a></li>
        ...
        <li class="nav-group">
            ...
            <ul class="nav-group-items">
                <li class="nav-item"><a class="nav-link"
                        href="{{ url('/dashboard/akademik/peraturan-rektor-tentang-akademik') }}"><span
                            class="nav-icon"></span>
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('/#') }}"><span class="nav-icon"></span>
                        ...
                        Akademik</a></li>
                <li class="nav-item"><a class="nav-link"
                        href="{{ url('/dashboard/akademik/kalender-akademik') }}"><span class="nav-icon"></span>
                        Kalender
                        Akademik</a></li>
                <li class="nav-item"><a class="nav-link"
                        href="{{ url('dashboard/akademik/jadwal-perkuliahan') }}"><span class="nav-icon"></span>
                        Jadwal
                        Perkuliahan</a></li>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            ...
            <ul class="nav-group-items">
                ...
                <li class="nav-item"><a class="nav-link"
                        href="{{ url('/dashboard/mahasiswa-alumni/lembaga-kemahasiswaan') }}"><span
                            class="nav-icon"></span>
                        Lembaga Kemahasiswaan</a></li>
                <li class="nav-item"><a class="nav-link"
                        href="{{ url('/dashboard/mahasiswa-alumni/registrasi-alumni') }}"><span
                            class="nav-icon"></span>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            ...
            <ul class="nav-group-items">
                ...
                <li class="nav-item"><a class="nav-link"
                        href="{{ url('/dashboard/tridharma/hak-kekayaan-intelektual') }}"><span
                            class="nav-icon"></span> Hak
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            ...
            <ul class="nav-group-items">
                <li class="nav-item"><a class="nav-link" href="login.html" target="_top">
                        <svg class="nav-icon">
                            <use
                                xlink:href="{{ asset('admin-assets') }}/vendors/@coreui/icons/svg/free.svg#cil-account-logout">
                            </use>
                        </svg> Login</a></li>
